        ...
        <div className="block lg:flex gap-20 mb-10 pb-10">
          <div className="w-full lg:w-4/12 mb-10 lg:mb-0">
            ...
            <p>
              ...
              >
                <span>{footerContent.about.cta}</span>
                <span className="w-6 h-6 rounded-full bg-primary text-white inline-flex items-center justify-center">
                  <BiChevronRight className="w-6 h-6 rounded-full bg-primary text-white inline-flex items-center justify-center duration-300 transition-all ease-in-out group-hover:bg-secondary" />
                </span>
              </Link>
            </p>
          </div>
              ...
              <ul className="p-0 m-0">
                {footerContent.footerLinks.map((link, idx) => (
                  <li className="mb-3" key={idx}>
                    <Link className="group flex items-center duration-300 transition-all ease-in-out hover:text-primary">
